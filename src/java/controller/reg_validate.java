 ...
 * @author student
 */
@WebServlet(name="reg_validate", urlPatterns={"/reg_validate.do"})
public class reg_validate extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet reg_validate</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet reg_validate at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
...
String query="insert into s_reg values(?,?,?,?,?,?,?)";
...
response.setHeader("Refresh", "3;url=s_login.jsp");
}
catch(Exception de)
{
out.println("Registration Failed!");
response.setHeader("Refresh", "2;url=s_register.jsp");
}
