<%-- 
    Document   : f_register
    Created on : May 6, 2013, 5:58:33 PM
    Author     : student
--%>
...
<a href="index.jsp"><button class="btn btn-success">HOME</button></a>
            <center><form class="form-signin" action="f_reg_validate" method="POST">
  <h2 class="form-signin-heading">Faculty Registration</h2>
            ...
            What course would you prefer to teach:<br>
